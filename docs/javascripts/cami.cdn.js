  ...
  var createURLStore = () => {
    ...
    return {
      ...
      navigate(options = {}) {
        ...
        if (!fullReplace) {
          Object.entries(store2.params).forEach(([key, value]) => searchParams.set(key, value));
          Object.entries(store2.hashParams).forEach(([key, value]) => hashSearchParams.set(key, value));
        }
