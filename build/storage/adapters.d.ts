...
export declare function removeDeep(
  obj: UnproxifyTarget,
  path: string[],
): UnproxifyTarget;
export declare function createIdbPromise({
  name,
  version,
  storeName,
  keyPath,
...
export declare function persistToIdbThunk({
  fromStateKey,
  toIDBStore,
}: PersistToIdbConfig): ({
  action: _action,
...
export declare function createLocalStorage({
  name,
  version,
}: LocalStorageConfig): LocalStorageAdapter;
export declare function persistToLocalStorageThunk(
  toLocalStorage: LocalStorageAdapter,
): ({ action: _action, state, previousState }: ThunkParams) => Promise<void>;
export {};
