...
registrationStore.defineQuery('checkEmailAvailability', {
  ...
  queryFn: email => fetch(`https://cami-api.exe.xyz/users?email=${email}`).then(res => res.json()),
...
customElements.define(
  ...
  class extends ReactiveElement {
    template() {
      const { email, password, emailError, passwordError, emailIsValid, isEmailAvailable } =
