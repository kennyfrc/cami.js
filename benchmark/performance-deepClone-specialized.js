...
new Benchmark.Suite('deepClone - TypedArrays')
  ...
  .on('complete', function () {
    ...
    console.log(
      'Slowest TypedArrays deepClone implementation is ' + this.filter('slowest').map('name')
    )
  })
  .run({ async: false })
...
new Benchmark.Suite('deepClone - Maps and Sets')
  ...
  .on('complete', function () {
    ...
    console.log(
      'Slowest Maps/Sets deepClone implementation is ' + this.filter('slowest').map('name')
    )
  })
  .run({ async: false })
...
new Benchmark.Suite('deepClone - Large Data Structures')
  ...
  .on('complete', function () {
    ...
    console.log(
      'Slowest Large Data deepClone implementation is ' + this.filter('slowest').map('name')
    )
  })
  .run({ async: false })
