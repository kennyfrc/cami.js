...
new Benchmark.Suite('deepClone - Specialized Tests')
  ...
  .on('complete', function () {
    console.log(
      'Fastest specialized deepClone implementation is ' + this.filter('fastest').map('name')
    )
  })
  .run({ async: false })
...
new Benchmark.Suite('deepEqual - Specialized Tests')
  ...
  .on('complete', function () {
    console.log(
      'Fastest specialized deepEqual implementation is ' + this.filter('fastest').map('name')
    )
  })
  .run({ async: false })
