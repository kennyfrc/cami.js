...
new Benchmark.Suite('deepEqual - TypedArrays (Equal)')
  ...
  .on('complete', function () {
    console.log(
      '\nFastest TypedArrays (equal) deepEqual implementation is ' +
        this.filter('fastest').map('name')
    )
    console.log(
      'Slowest TypedArrays (equal) deepEqual implementation is ' +
...
new Benchmark.Suite('deepEqual - TypedArrays (Unequal)')
  ...
  .on('complete', function () {
    console.log(
      '\nFastest TypedArrays (unequal) deepEqual implementation is ' +
        this.filter('fastest').map('name')
    )
    console.log(
      'Slowest TypedArrays (unequal) deepEqual implementation is ' +
        this.filter('slowest').map('name')
    )
  })
  .run({ async: false })
...
new Benchmark.Suite('deepEqual - Maps and Sets (Equal)')
  ...
  .on('complete', function () {
    console.log(
      '\nFastest Maps/Sets (equal) deepEqual implementation is ' +
        this.filter('fastest').map('name')
    )
    console.log(
      'Slowest Maps/Sets (equal) deepEqual implementation is ' + this.filter('slowest').map('name')
    )
  })
  .run({ async: false })
...
new Benchmark.Suite('deepEqual - Maps and Sets (Unequal)')
  ...
  .on('complete', function () {
    console.log(
      '\nFastest Maps/Sets (unequal) deepEqual implementation is ' +
        this.filter('fastest').map('name')
    )
    console.log(
      'Slowest Maps/Sets (unequal) deepEqual implementation is ' +
        this.filter('slowest').map('name')
    )
  })
  .run({ async: false })
...
new Benchmark.Suite('deepEqual - Large Data Structures')
  ...
  .on('complete', function () {
    ...
    console.log(
      'Slowest Large Data deepEqual implementation is ' + this.filter('slowest').map('name')
    )
  })
  .run({ async: false })
