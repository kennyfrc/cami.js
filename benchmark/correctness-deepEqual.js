...
const testCases = [
  ...
  {
    name: 'Simple equal objects',
    a: { a: 1, b: 2 },
    b: { a: 1, b: 2 },
    expected: true,
  },
  {
    name: 'Simple unequal objects',
    a: { a: 1, b: 2 },
    b: { a: 1, b: 3 },
    expected: false,
  },
  ...
  // TypedArrays
  {
    name: 'Int8Array equal',
    a: new Int8Array([1, 2, 3]),
    b: new Int8Array([1, 2, 3]),
    expected: true,
  },
  {
    name: 'Int8Array different',
    a: new Int8Array([1, 2, 3]),
    b: new Int8Array([1, 2, 4]),
    expected: false,
  },
  {
    name: 'Different typed arrays',
    a: new Int8Array([1, 2, 3]),
    b: new Uint8Array([1, 2, 3]),
    expected: false,
  },
  {
    name: 'TypedArray vs array',
    a: new Int8Array([1, 2, 3]),
    b: [1, 2, 3],
    expected: false,
  },
...
const createDifferentCircularTest = () => {
  ...
  return {
    name: 'Different circular reference',
    a: obj1,
    b: obj2,
    expected: false,
  }
