...
new Benchmark.Suite('deepEqual - Equal Objects')
  ...
  .on('complete', function() {
    ...
    console.log('Slowest equal objects deepEqual implementation is ' + this.filter('slowest').map('name'));
  })
  .run({ async: false });
...
new Benchmark.Suite('deepEqual - Unequal Objects')
  ...
  .on('complete', function() {
    ...
    console.log('Slowest unequal objects deepEqual implementation is ' + this.filter('slowest').map('name'));
  })
  .run({ async: false });